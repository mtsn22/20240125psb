...
<body class="font-raleway antialiased bg-tsn-bg no-scrollbar">
        ...
        <div class="col-span-3">
            <div class="relative justify-self-center">
                <div class=" bottom-0 flex w-full justify-center">
                    <p class="lg:text-5xl sm:text-5xl text-white font-raleway"><strong>PENERIMAAN SANTRI
                            BARU</strong></p>
                </div>
                <div class="flex w-full justify-center">
                    <p class="lg:text-5xl sm:text-5xl text-white font-raleway"><strong>MA'HAD
                            TA'DZIMUSSUNNAH</strong></p>
                </div>
                <div class="flex w-full justify-center">
                    <p class="lg:text-5xl sm:text-5xl text-white font-raleway"><strong>SINE NGAWI</strong></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="flex w-full pt-8 justify-center flex-col">
        <div>
            <p class="lg:text-3xl sm:text-2xl text-tsn-header font-raleway text-center"><strong>WAKTU
                    PENDAFTARAN</strong>
            </p>
        </div>
        {{-- <div>
        ...
        <div>
            <p class="lg:text-3xl sm:text-2xl text-tsn-header font-raleway text-center">Februari 2024 s/d Maret
                2024
            </p>
        </div>
        <div>
        ...
        <div class="justify-center flex text-xs">
            <ul class="timeline timeline-vertical lg:timeline-horizontal">
                <li>
                  <div class="timeline-start timeline-box"><strong>Pengisian Formulir Tahap 1:</strong>
                    <br>
                    29 Januari 2024 s/d
                    <br>
                    1 Februari 2024
                  ...
                  <div class="timeline-middle">
                    {{-- @svg('heroicon-s-arrow-left-circle', 'w-5 h-5', ['style'=> 'color: #274043']) --}}
                    @svg('heroicon-o-stop', 'w-5 h-5', ['style'=> 'color: #274043'])
                  </div>
                ...
                <hr/>
                  ...
                  <div class="timeline-end timeline-box"><strong>Penyeleksian Tahap 1:</strong>
                    <br>
                    2 Februari 2024 s/d
                    <br>
                    3 Februari 2024
                ...
                <li>
                  {{-- <hr class="bg-tsn-accent"/> --}}
                  <hr/>
                  <div class="timeline-start timeline-box"><strong>Pengumuman Tahap 1:</strong>
                    <br>
                    4 Februari 2024
                  </div>
                  <div class="timeline-middle">
                ...
                <li>
                  ...
                  <div class="timeline-end timeline-box"><strong>Pengisian Formulir Tahap 2:</strong>
                    <br>
                    5 Februari 2024 s/d
                    <br>
                    15 Februari 2024
                ...
                <li>
                  <hr/>
                  <div class="timeline-start timeline-box"><strong>Penyeleksian Tahap 2:</strong>
                    <br>
                    16 Februari 2024 s/d
                    <br>
                    17 Februari 2024
                  </div>
                  <div class="timeline-middle">
                ...
                <li>
                    ...
                    <div class="timeline-end timeline-box"><strong>Pengumuman hasil penerimaan untuk santri naik qism:</strong>
                      <br>
                      18 Februari 2024
                    </div>
                    <hr/>
                  ...
                  <li>
                    <hr/>
                    <div class="timeline-start timeline-box"><strong>Pengumuman hasil penerimaan untuk santri baru:</strong>
                      <br>
                      20 Februari 2024
                    </div>
                    <div class="timeline-middle">
                  ...
                  <li>
                    ...
                    <div class="timeline-end timeline-box"><strong>Pengisian formulir tahap 3 dan 4:</strong>
                        <br>
                        20 Februari 2024 s/d
                        <br>
                        29 Februari 2024
                    </div>
                  </li>
        ...
        {{-- <div class="w-full justify-center flex">
            <div role="alert" class="alert alert-warning w-fit flex flex-row">
        ...
        <div class="w-full justify-center flex">
            <div class="flex px-3 py-3 w-fit justify-center justify-self-center">
                ...
                <div class="grid grid-cols-1 card lg:card-side bg-base-100 shadow-xl px-4 py-4">
                    <div class="card-body">
                        <h2 class="card-title self-center text-center text-tsn-header">Mulai Pendaftaran Santri Baru
                        </h2>
                    </div>
                    <div>
                        <!-- Session Status -->
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <!-- Username -->
                            <div class="pt-4">
                                <x-input-label for="username" :value="__('Masukkan nomor KK')" />
                                <x-text-input id="username" class="block mt-1 w-full" type="text" name="username" minlength="16" maxlength="16"
                                    :value="old('username')" required autofocus autocomplete="username" />
                                {{-- <x-input-error :messages="$errors->get('username')" class="mt-2" /> --}}
                            </div>

                            <div class="pt-4">
                                <x-input-label for="name" :value="__('Masukkan Nama Lengkap Walisantri')" />
    ...
    <div class="w-full justify-center flex">
        <div class="flex px-3 py-3 w-fit justify-center justify-self-center">
            ...
            <div class="grid grid-cols-1 card lg:card-side bg-base-100 shadow-xl px-4 py-4">
                <div class="card-body">
                    <h2 class="card-title self-center text-center text-tsn-header">Mulai Pendaftaran Santri Lama</h2>
                ...
                <div>
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <!-- Username -->
                        <div class="pt-4">
                            <x-input-label for="kk" :value="__('Masukkan nomor KK')" />
                            <x-text-input id="kk" class="block mt-1 w-full" type="text" name="kk" minlength="16" maxlength="16"
                                :value="old('kk')" required autofocus autocomplete="kk" />
                            <x-input-error :messages="$errors->get('username')" class="mt-2" />
                        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th><a href="https://wa.me/6282328485257">@svg('heroicon-o-phone', 'w-4 h-4', ['style'
                                        => 'color: #274043'])</a></th>
                                <td class="text-tsn-header"><a href="https://wa.me/6282328485257">Kontak person putri</a></td>
                            </tr>
                        </tbody>
                    </table>
                    <br>
                            ...
                            <div class="modal-box">
                                ...
                                <div>
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <th>6</th>
                                                <td>Anak didik memiliki hafalan Al Qur’an ( Juz Amma ) dan doa sehari-hari
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                ...
                                <div>
                                    <table class="table">
                                        ...
                                        <thead>
                                            <tr class="border-tsn-header">
                                                <th class="text-lg text-tsn-header" colspan="2">DOKUMEN-DOKUMEN PERSYARATAN</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                            ...
                                            <tr>
                                                <th>6</th>
                                                <td>Surat Kuasa dari Orangtua Kandung (Jika yang mendaftarkan adalah wali)</td>
                                            </tr>
                                            <tr>
                                                <th>7</th>
                                            ...
                                            <tr>
                                                <th>8</th>
                                                <td>Surat pernyataan kesanggupan bermaterai (Format Surat dapat diunduh dari formulir)</td>
                                            </tr>
                                            <tr>
                                                <th>9</th>
                                                <td>Surat Permohonan Keringanan Administrasi (bagi yang mengajukan keringanan)</td>
                                            </tr>
                                            <tr>
                                                <th>10</th>
                                                <td>Surat Keterangan tidak mampu dari Ustadz setempat (bagi yang mengajukan keringanan)</td>
                                            </tr>
                                            <tr>
                                                <th>11</th>
                                                <td>Surat Keterangan tidak mampu dari aparat pemerintah setempat (bagi yang mengajukan keringanan)</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                ...
                                <div class="flex sticky bottom-0 bg-transparent w-full justify-between rounded-xl">
                                    <button class="btn bg-tsn-accent focus:bg-tsn-bg" onclick="daftar_pt.showModal()">Daftar</button>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th><a href="https://wa.me/6285234772629">@svg('heroicon-o-phone', 'w-4 h-4', ['style'
                                        => 'color: #274043'])</a></th>
                                <td class="text-tsn-header"><a href="https://wa.me/6285234772629">Kontak person putri</a></td>
                            </tr>
                        </tbody>
                    </table>
                    <br>
                        ...
                        <dialog id="rincian_program_pt" class="modal">
                            <div class="modal-box">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>Adanya program menginap terkhusus anak kelas 5 dan 6, yang dibedakan
                                                    sesuai dengan tingkat kesiapan anak pada tiap tingkatan kelasnya</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <table>
                                                ...
                                                <thead>
                                                    <tr class="border-b">
                                                        <th class="text-lg text-tsn-header" colspan="4">RINCIAN BIAYA AWAL DAN SPP</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                            <!-- row 1 -->
...
<br>
    <div class="carousel rounded-xl w-full h-full shadow-xl">
        <div id="slide1" class="carousel-item relative w-full">
            ...
            <div class="bg-base-100 absolute flex justify-between transform left-2 -translate-y-1/2 5 bottom-0">
